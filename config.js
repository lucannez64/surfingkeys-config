...
const opt_br = {favicon_url: "https://icons.duckduckgo.com/ip3/brave.com.ico"};

api.addSearchAlias('br', 'Brave Search', 'https://search.brave.com/search?q=', 's', 'https://search.brave.com/api/suggest?q=', function(response) {
